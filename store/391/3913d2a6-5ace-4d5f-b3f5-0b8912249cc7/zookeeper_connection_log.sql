ATTACH TABLE _ UUID '425de945-bfc2-4686-adb7-a5dbf99767d0'
(
    ...
    `enabled_feature_flags` Array(Enum16('FILTERED_LIST' = 0, 'MULTI_READ' = 1, 'CHECK_NOT_EXISTS' = 2, 'CREATE_IF_NOT_EXISTS' = 3, 'REMOVE_RECURSIVE' = 4, 'MULTI_WATCHES' = 5, 'CHECK_STAT' = 6)) COMMENT 'Feature flags which are enabled. Only applicable to ClickHouse Keeper.',
